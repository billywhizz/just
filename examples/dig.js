...
const { create, parse, getFlags, qtypes, qclasses } = just.require('./lib/dns.js')
const { loop } = just.factory

function lookup ({ query = 'www.google.com', address = '8.8.8.8', port = 53 }, buf = new ArrayBuffer(65536)) {
...
global.onUnhandledRejection = (promise, err, event) => {
  just.error('onUnahdledRejection')
