const WabtModule = just.require('./libwabt.min.js')
const { readFileBytes, writeFile } = just.require('fs')

/*
global.process = {}
global.__dirname = just.sys.cwd()
process.argv = just.args
process.on = (name, fn) => {
  process[name] = fn
}
console.warn = (data, ...args) => {}
*/
const binarySettings = { log: true, write_debug_names: false }
const features = {
  exceptions: false,
...
module.exports = { compile, save, load, evaluate, createMemory, binarySettings, features }
